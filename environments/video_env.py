...
class VideoEnv(BaseEnv):
    def __init__(self, env_name, directory=None, force=False, prefix="", **env_kwargs):
        if directory is None: 
            directory = os.path.join(logger.log_dir, f'videos_{prefix}')
        inner_env = SimpleEnv(env_name, **env_kwargs)
