...
from collectors.base_collector import BaseStepCollector
from utils.collector_utils import split_items, PathBuilder, get_valid_part, cut_path, NAME_LIST
from utils.eval_utils import create_stats_ordered_dict
from utils.misc_utils import combine_items


class StepCollector(BaseStepCollector):
    ...
    def __init__(
            ...
            render_kwargs={},
            **collector_kwargs):
        super().__init__(env, policy, max_num_epoch_paths_saved, render, render_kwargs, **collector_kwargs)
    ...
    def _collect_one_step(self):
        ...
        o = self._obs
        a, agent_info = self._policy.action_np(o, **self._action_kwargs)
        next_o, r, d, env_info = self._env.step(a, **self._step_kwargs)
